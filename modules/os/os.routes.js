...
const OS_VIEW = ["ADMIN", "DIRECAO", "DIRETORIA", "ENCARREGADO_PRODUCAO", "PRODUCAO", "MANUTENCAO", "MECANICO"];
const OS_OPEN = ["ADMIN", "DIRECAO", "DIRETORIA", "ENCARREGADO_PRODUCAO", "PRODUCAO", "MANUTENCAO", "MECANICO"];
const OS_EXECUTE = ["ADMIN", "MANUTENCAO", "MECANICO"];
