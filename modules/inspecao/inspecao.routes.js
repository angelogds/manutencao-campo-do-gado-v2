...
router.post("/:ano/:mes/editar", requireLogin, requireRole(EDIT_ACCESS), wrap(ctrl.editStatus));
...
router.get("/:ano/:mes/export/xls", requireLogin, requireRole(VIEW_ACCESS), wrap(ctrl.exportXLS));
