...
router.get('/boca-de-lobo-excentrica', requireLogin, requireRole(VIEW_ACCESS), withMenu(ctrl.bocaLoboExcentricaForm));
router.post('/boca-de-lobo-excentrica/calcular', requireLogin, requireRole(MANAGE_ACCESS), withMenu(ctrl.bocaLoboExcentricaCalcular));
router.get('/boca-de-lobo-45-graus', requireLogin, requireRole(VIEW_ACCESS), withMenu(ctrl.bocaLobo45Form));
router.post('/boca-de-lobo-45-graus/calcular', requireLogin, requireRole(MANAGE_ACCESS), withMenu(ctrl.bocaLobo45Calcular));
router.get('/boca-de-lobo-90-graus', requireLogin, requireRole(VIEW_ACCESS), withMenu(ctrl.bocaLobo90Form));
router.post('/boca-de-lobo-90-graus/calcular', requireLogin, requireRole(MANAGE_ACCESS), withMenu(ctrl.bocaLobo90Calcular));
