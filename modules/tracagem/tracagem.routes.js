...
router.get('/boca-lobo-45', requireLogin, requireRole(VIEW_ACCESS), withMenu(ctrl.bocaLobo45Form));
router.post('/boca-lobo-45/calcular', requireLogin, requireRole(MANAGE_ACCESS), withMenu(ctrl.bocaLobo45Calcular));
router.get('/boca-lobo-90', requireLogin, requireRole(VIEW_ACCESS), withMenu(ctrl.bocaLobo90Form));
router.post('/boca-lobo-90/calcular', requireLogin, requireRole(MANAGE_ACCESS), withMenu(ctrl.bocaLobo90Calcular));
...
router.get('/boca-de-lobo-45-graus', requireLogin, requireRole(VIEW_ACCESS), (_req, res) => res.redirect('/tracagem/boca-lobo-45'));
router.post('/boca-de-lobo-45-graus/calcular', requireLogin, requireRole(MANAGE_ACCESS), (_req, res) => res.redirect('/tracagem/boca-lobo-45'));
router.get('/boca-de-lobo-90-graus', requireLogin, requireRole(VIEW_ACCESS), (_req, res) => res.redirect('/tracagem/boca-lobo-90'));
router.post('/boca-de-lobo-90-graus/calcular', requireLogin, requireRole(MANAGE_ACCESS), (_req, res) => res.redirect('/tracagem/boca-lobo-90'));
